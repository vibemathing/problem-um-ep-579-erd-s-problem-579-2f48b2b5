...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-579-erd-s-problem-579-2f48b2b5-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-579"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-579-erd-s-problem-579-2f48b2b5-v1",
      "problem_contract_sha256": "311ddfb229c0621d8c636e18fc56015dded74872b6e6a2582cb2f53259229cf8",
      "problem_id": "problem:um-ep-579-erd-s-problem-579-2f48b2b5",
      "route_id": "route:um-ep-579-erd-s-problem-579-2f48b2b5-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-579-erd-s-problem-579-2f48b2b5-source-fidelity-01",
      "graph_id": "graph:um-ep-579-erd-s-problem-579-2f48b2b5-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-579-erd-s-problem-579-2f48b2b5-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-579-erd-s-problem-579-2f48b2b5-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $\\delta>0$. If $n$ is sufficiently large and $G$ is a graph on $n$ vertices with no $K_{2,2,2}$ and at least $\\delta n^2$ edges then $G$ contains an independent set of size $\\gg_\\delta n$."
          },
          "statement_sha256": "1304ef0e517beea5154533f19cca6716bb430dd87164bab40f3e44a02c094f16"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-579-erd-s-problem-579-2f48b2b5-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-579-erd-s-problem-579-2f48b2b5-root",
      "route_id": "route:um-ep-579-erd-s-problem-579-2f48b2b5-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-579-5b855a9f444f",
        "url": "https://www.unsolvedmath.com/problems/EP-579"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
